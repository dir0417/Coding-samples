...
folder_path <- "C:/Users/dair/Downloads/blue"
...
additional_file <- read_excel("C:/Users/dair/Downloads/facilities.xlsx")
...
final_merged_remove_col_df <- final_merged_df %>%
  select('Facility Name','EMResource Region', 'Ped Medical/Surgical - Available', 'PICU - Available (current)', 'ICU Bed Availability (current)', 'Adult Med/Surgical – Available (current)', 'Operating Rooms (OR) - Available', 
         'Psychiatric (MP)','FileName', 'Date Collected','Address', 'County', 'Latitude', 'Longitude', 'License #  (State will populate)', 'Last Update' )
...
output_file_path <- "C:/Users/dair/Downloads/final_merged_output.xlsx"
